...
bloobs=datasets.make_blobs(n_samples=n_samples)
...
datasets=[noisy_circles,noisy_moons,bloobs,no_structure]
...
for i_dataset,dataset in enumerate(datasets):
    ...
    spect=cluster.SpectralClustering(n_clusters=2)
    ...
    clustering_algorithms=[two_means,ward,spect,dbscan,average_linkage,birch]
