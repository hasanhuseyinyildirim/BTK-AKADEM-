...
#Ridge -->gereksiz parametrelerin katsayısı küçültülür
...
print("Ridge en iyi parameter.:",ridge_grid_search.best_params_)
...
#Lasso -->gereksiz parametreler sıfır kabul edilir
...
print("Lasso en iyi parameter.:",lasso_grid_search.best_params_)
