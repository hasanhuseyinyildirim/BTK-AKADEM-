...
# with open("bölüm-8/arabalar.csv","w",newline="") as file:
...
# with open("bölüm-8/arabalar.csv","a") as file:
#     csv_writer=csv.writer(file)
#     csv_writer.writerow(["Mazda","CX-5"])
...
#     with open("bölüm-8/yeni_urunler.csv","w",newline="") as f:
#         csv_writer=csv.writer(f)
#         for urun in csv_reader:
#             csv_writer.writerow([u.lower() for u in urun])


with open("bölüm-8/urunler.csv","r+",newline="") as file:
    csv_reader =csv.reader(file)
    csv_writer= csv.writer(file)
